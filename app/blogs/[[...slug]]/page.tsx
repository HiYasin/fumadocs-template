import { getPageImage, getPageMarkdownUrl, blogSource } from '@/lib/source';
// We can create a page for our blogs by using 'blogSource' instead of 'source'. Everything else can stay same.
import {
  DocsBody,
  DocsDescription,
  DocsPage,
